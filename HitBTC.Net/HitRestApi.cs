...
namespace HitBTC.Net
{
    public class HitRestApi
    {
        ...
        /// <param name="cancellationToken">Token for cancel operation</param>
        /// <returns></returns>
        public async Task<HitResponse<HitCandle[]>> GetCandlesAsync(string symbol, HitPeriod? period = null, int? limit = null, int? offset = null, string sort = "DESC", CancellationToken cancellationToken = default) =>
